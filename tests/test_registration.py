...
class TestRegistration:
    ...
    @pytest.mark.parametrize('password', ['5', '12345'])
    ...
    #Регистрация с полем Email вне формата логин@домен
    @pytest.mark.parametrize('email', ['@yandex.ru', 'david_asatiani_19_123'])
